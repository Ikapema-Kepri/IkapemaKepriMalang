...
const FilosofiData: FilosofiLogoCardProps[] = [
  {
    ...
    logoUrl: "/filosofiLogo/KelopakMerah.webp",
    description: "Pancasila sebagai dasar negara",
  },
  {
    title: "Kapal Perahu",
    logoUrl: "/filosofiLogo/KapalKuning.webp",
    description:
      "Semangat rakyat Provinsi Kepulauan Riau dengan hasil laut yang melimpah",
  },
  {
    title: "Padi & Kapas",
    logoUrl: "/filosofiLogo/PadiKapas.webp",
    description: "Kemakmuran dan kesejahteraan rakyat Provinsi Kepulauan Riau",
  },
  {
    title: "Buku",
    logoUrl: "/filosofiLogo/Buku.webp",
    description:
      "Semangat belajar anggota Ikatan Pelajar Mahasiswa Kepulauan Riau-Malang (IKAPEMA Kepri-Malang)",
  },
  {
    title: "Nama Organisasi",
    logoUrl: "/filosofiLogo/NamaOrganisasi.webp",
    description: "Tulisan dalam lingkaran lima kelopak bunga warna merah merupkan nama wadah organisasi.",
  },
];

const FilosofiLogoCard: React.FC = () => {
  return (
    <div className="flex flex-col gap-8 md:gap-16 lg:gap-32 px-4">
      {/* 4 kartu pertama dalam grid 2x2 */}
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-16 lg:gap-32">
        {FilosofiData.slice(0, 4).map((item, index) => (
      ...
      {FilosofiData[4] && (
        <div className="flex justify-center">
          <div className="flex flex-col items-center justify-center gap-6 md:gap-8 lg:gap-12">
            ...
            <div className="flex flex-col items-center">
              <Image
                src={FilosofiData[4].logoUrl}
                alt={FilosofiData[4].title}
                width={350}
                height={350}
                className="w-[200px] h-[200px] sm:w-[250px] sm:h-[250px] md:w-[300px] md:h-[300px] lg:w-[350px] lg:h-[350px] object-contain"
              />
