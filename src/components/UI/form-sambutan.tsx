  ...
  return (
    <div className="rounded-lg border border-border bg-card shadow-sm">
      ...
      <div className="px-4 py-4 border-b border-border flex items-center justify-between">
        <div>
          <h2 className="text-lg font-semibold text-foreground">Sambutan Section</h2>
        </div>
        <button
          type="button"
          ...
          <TableRow className="hover:bg-transparent">
            <TableCell className="align-top py-6">
              <div className="flex md:grid flex-col md:grid-cols-5 gap-8">
                ...
                {/* Grid 2 — Nama, Periode, Kata Sambutan */}
                <div className="col-span-4 flex flex-col gap-5">
                  <div className="flex flex-col gap-1.5">
                    <label className="text-sm font-medium text-foreground">Nama Ketua Umum</label>
                    <input
                      type="text"
                      value={nama}
